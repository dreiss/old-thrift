...
class VersioningTestV1 {
 public:
  ...
  static const char* ascii_fingerprint; // = "238B1BA854318E1BDB028A226266884E";
  static const uint8_t binary_fingerprint[16]; // = {0x23,0x8B,0x1B,0xA8,0x54,0x31,0x8E,0x1B,0xDB,0x02,0x8A,0x22,0x62,0x66,0x88,0x4E};

  VersioningTestV1() : begin_in_both(0), end_in_both(0) {
  }
  ...
  struct __isset {
    __isset() : begin_in_both(false), end_in_both(false) {}
    bool begin_in_both;
    bool end_in_both;
  } __isset;
