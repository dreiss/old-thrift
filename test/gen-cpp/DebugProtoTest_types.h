...
class Backwards {
 public:
  ...
  Backwards() : second_tag1(0), first_tag2(0) {
  }
  ...
  struct __isset {
    __isset() : second_tag1(false), first_tag2(false) {}
    bool second_tag1;
    bool first_tag2;
  } __isset;
...
class CompactProtoTestStruct {
 public:
  ...
  CompactProtoTestStruct() : a_byte(127), a_i16(32000), a_i32(1000000000), a_i64(1099511627775LL), a_double(5.6789), a_string("my string"), a_binary(""), true_field(true), false_field(false) {
    ...
    struct_list.push_back(tmp65);
    Empty tmp66;

    struct_list.push_back(tmp66);
    ...
    std::vector<int8_t>  tmp68;
    tmp68.push_back(1);
    tmp68.push_back(2);
    tmp68.push_back(3);

    list_byte_map.insert(std::make_pair(tmp68, 1));
    std::vector<int8_t>  tmp69;
    tmp69.push_back(0);
    tmp69.push_back(1);

    list_byte_map.insert(std::make_pair(tmp69, 2));
    std::vector<int8_t>  tmp70;

    list_byte_map.insert(std::make_pair(tmp70, 0));

    std::set<int8_t>  tmp71;
    tmp71.insert(1);
    tmp71.insert(2);
    tmp71.insert(3);

    set_byte_map.insert(std::make_pair(tmp71, 1));
    std::set<int8_t>  tmp72;
    tmp72.insert(0);
    tmp72.insert(1);

    set_byte_map.insert(std::make_pair(tmp72, 2));
    std::set<int8_t>  tmp73;

    set_byte_map.insert(std::make_pair(tmp73, 0));

    std::map<int8_t, int8_t>  tmp74;
    tmp74.insert(std::make_pair(1, 1));

    map_byte_map.insert(std::make_pair(tmp74, 1));
    std::map<int8_t, int8_t>  tmp75;
    tmp75.insert(std::make_pair(2, 2));

    map_byte_map.insert(std::make_pair(tmp75, 2));
    std::map<int8_t, int8_t>  tmp76;

    map_byte_map.insert(std::make_pair(tmp76, 0));

    std::map<int8_t, int8_t>  tmp77;

    byte_map_map.insert(std::make_pair(0, tmp77));
    std::map<int8_t, int8_t>  tmp78;
    tmp78.insert(std::make_pair(1, 1));

    byte_map_map.insert(std::make_pair(1, tmp78));
    std::map<int8_t, int8_t>  tmp79;
    tmp79.insert(std::make_pair(1, 1));
    tmp79.insert(std::make_pair(2, 2));

    byte_map_map.insert(std::make_pair(2, tmp79));

    std::set<int8_t>  tmp80;

    byte_set_map.insert(std::make_pair(0, tmp80));
    std::set<int8_t>  tmp81;
    tmp81.insert(1);

    byte_set_map.insert(std::make_pair(1, tmp81));
    std::set<int8_t>  tmp82;
    tmp82.insert(1);
    tmp82.insert(2);

    byte_set_map.insert(std::make_pair(2, tmp82));

    std::vector<int8_t>  tmp83;

    byte_list_map.insert(std::make_pair(0, tmp83));
    std::vector<int8_t>  tmp84;
    tmp84.push_back(1);

    byte_list_map.insert(std::make_pair(1, tmp84));
    std::vector<int8_t>  tmp85;
    tmp85.push_back(1);
    tmp85.push_back(2);

    byte_list_map.insert(std::make_pair(2, tmp85));
