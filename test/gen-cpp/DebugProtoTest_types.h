...
class TestUnion {
 public:
  ...
  static const char* ascii_fingerprint; // = "8BC951015AABA93BF62CD87CE949F54C";
  static const uint8_t binary_fingerprint[16]; // = {0x8B,0xC9,0x51,0x01,0x5A,0xAB,0xA9,0x3B,0xF6,0x2C,0xD8,0x7C,0xE9,0x49,0xF5,0x4C};
  ...
  struct __isset {
    __isset() : string_field(false), i32_field(false), struct_field(false), struct_list(false), other_i32_field(false) {}
    bool string_field;
    bool i32_field;
    bool struct_field;
    bool struct_list;
...
class StructWithAUnion {
 public:
  ...
  static const char* ascii_fingerprint; // = "BA0B329A8FB8C252EBF6CD11D1C48F2D";
  static const uint8_t binary_fingerprint[16]; // = {0xBA,0x0B,0x32,0x9A,0x8F,0xB8,0xC2,0x52,0xEB,0xF6,0xCD,0x11,0xD1,0xC4,0x8F,0x2D};
