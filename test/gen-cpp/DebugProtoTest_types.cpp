    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->enum_field = (SomeEnum)ecast570;
...
uint32_t TestUnion::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, this->struct_list.size());
    std::vector<RandomStuff> ::const_iterator _iter571;
    for (_iter571 = this->struct_list.begin(); _iter571 != this->struct_list.end(); ++_iter571)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype573, _vtype574, _size572);
            uint32_t _i576;
            for (_i576 = 0; _i576 < _size572; ++_i576)
            {
              int32_t _key577;
              xfer += iprot->readI32(_key577);
              int32_t& _val578 = this->somemap_field[_key577];
              xfer += iprot->readI32(_val578);
            }
            iprot->readMapEnd();
          }
...
uint32_t StructWithASomemap::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("somemap_field", ::apache::thrift::protocol::T_MAP, 1);
  {
    ...
    std::map<int32_t, int32_t> ::const_iterator _iter579;
    for (_iter579 = this->somemap_field.begin(); _iter579 != this->somemap_field.end(); ++_iter579)
    {
      xfer += oprot->writeI32(_iter579->first);
      xfer += oprot->writeI32(_iter579->second);
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
