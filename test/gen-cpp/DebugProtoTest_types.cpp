        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              std::vector<int32_t>  _key455;
              {
                _key455.clear();
                uint32_t _size457;
                ::apache::thrift::protocol::TType _etype460;
                iprot->readListBegin(_etype460, _size457);
                _key455.resize(_size457);
                uint32_t _i461;
                for (_i461 = 0; _i461 < _size457; ++_i461)
                {
                  xfer += iprot->readI32(_key455[_i461]);
                }
                iprot->readListEnd();
              }
              std::set<std::map<int32_t, std::string> > & _val456 = this->b1[_key455];
              {
                _val456.clear();
                uint32_t _size462;
                ::apache::thrift::protocol::TType _etype465;
                iprot->readSetBegin(_etype465, _size462);
                uint32_t _i466;
                for (_i466 = 0; _i466 < _size462; ++_i466)
                {
                  std::map<int32_t, std::string>  _elem467;
                  {
                    _elem467.clear();
                    uint32_t _size468;
                    ::apache::thrift::protocol::TType _ktype469;
                    ::apache::thrift::protocol::TType _vtype470;
                    iprot->readMapBegin(_ktype469, _vtype470, _size468);
                    uint32_t _i472;
                    for (_i472 = 0; _i472 < _size468; ++_i472)
                    {
                      int32_t _key473;
                      xfer += iprot->readI32(_key473);
                      std::string& _val474 = _elem467[_key473];
                      xfer += iprot->readString(_val474);
                    }
                    iprot->readMapEnd();
                  }
                  _val456.insert(_elem467);
                }
                iprot->readSetEnd();
              }
            }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype476, _vtype477, _size475);
            uint32_t _i479;
            for (_i479 = 0; _i479 < _size475; ++_i479)
            {
              std::vector<int32_t>  _key480;
              {
                _key480.clear();
                uint32_t _size482;
                ::apache::thrift::protocol::TType _etype485;
                iprot->readListBegin(_etype485, _size482);
                _key480.resize(_size482);
                uint32_t _i486;
                for (_i486 = 0; _i486 < _size482; ++_i486)
                {
                  xfer += iprot->readI32(_key480[_i486]);
                }
                iprot->readListEnd();
              }
              std::set<std::map<int32_t, std::string> > & _val481 = this->b2[_key480];
              {
                _val481.clear();
                uint32_t _size487;
                ::apache::thrift::protocol::TType _etype490;
                iprot->readSetBegin(_etype490, _size487);
                uint32_t _i491;
                for (_i491 = 0; _i491 < _size487; ++_i491)
                {
                  std::map<int32_t, std::string>  _elem492;
                  {
                    _elem492.clear();
                    uint32_t _size493;
                    ...
                    for (_i497 = 0; _i497 < _size493; ++_i497)
                    {
                      ...
                      std::string& _val499 = _elem492[_key498];
                      xfer += iprot->readString(_val499);
                    }
                    iprot->readMapEnd();
                  }
                  _val481.insert(_elem492);
                }
                iprot->readSetEnd();
              }
            }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
              std::vector<int32_t>  _key530;
              {
                _key530.clear();
                uint32_t _size532;
                ::apache::thrift::protocol::TType _etype535;
                iprot->readListBegin(_etype535, _size532);
                _key530.resize(_size532);
                uint32_t _i536;
                for (_i536 = 0; _i536 < _size532; ++_i536)
                {
                  xfer += iprot->readI32(_key530[_i536]);
                }
                iprot->readListEnd();
              }
              std::set<std::map<int32_t, std::string> > & _val531 = this->b4[_key530];
              {
                _val531.clear();
                uint32_t _size537;
                ::apache::thrift::protocol::TType _etype540;
                iprot->readSetBegin(_etype540, _size537);
                uint32_t _i541;
                for (_i541 = 0; _i541 < _size537; ++_i541)
                {
                  std::map<int32_t, std::string>  _elem542;
                  {
                    _elem542.clear();
                    uint32_t _size543;
                    ::apache::thrift::protocol::TType _ktype544;
                    ::apache::thrift::protocol::TType _vtype545;
                    iprot->readMapBegin(_ktype544, _vtype545, _size543);
                    uint32_t _i547;
                    for (_i547 = 0; _i547 < _size543; ++_i547)
                    {
                      int32_t _key548;
                      xfer += iprot->readI32(_key548);
                      std::string& _val549 = _elem542[_key548];
                      xfer += iprot->readString(_val549);
                    }
                    iprot->readMapEnd();
                  }
                  _val531.insert(_elem542);
                }
                iprot->readSetEnd();
              }
            }
...
uint32_t BlowUp::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("b1", ::apache::thrift::protocol::T_MAP, 1);
  {
    ...
    for (_iter550 = this->b1.begin(); _iter550 != this->b1.end(); ++_iter550)
    {
      {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32, _iter550->first.size());
      ...
      {
        xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_MAP, _iter550->second.size());
        ...
        {
          {
            xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_STRING, (*_iter552).size());
  ...
  xfer += oprot->writeFieldBegin("b2", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    std::map<std::vector<int32_t> , std::set<std::map<int32_t, std::string> > > ::const_iterator _iter554;
    for (_iter554 = this->b2.begin(); _iter554 != this->b2.end(); ++_iter554)
    {
      {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32, _iter554->first.size());
        std::vector<int32_t> ::const_iterator _iter555;
        for (_iter555 = _iter554->first.begin(); _iter555 != _iter554->first.end(); ++_iter555)
        {
      ...
      {
        xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_MAP, _iter554->second.size());
        std::set<std::map<int32_t, std::string> > ::const_iterator _iter556;
        for (_iter556 = _iter554->second.begin(); _iter556 != _iter554->second.end(); ++_iter556)
        {
          {
            xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_STRING, (*_iter556).size());
            std::map<int32_t, std::string> ::const_iterator _iter557;
            for (_iter557 = (*_iter556).begin(); _iter557 != (*_iter556).end(); ++_iter557)
            {
              xfer += oprot->writeI32(_iter557->first);
              xfer += oprot->writeString(_iter557->second);
            }
            xfer += oprot->writeMapEnd();
          }
        }
  ...
  xfer += oprot->writeFieldBegin("b3", ::apache::thrift::protocol::T_MAP, 3);
  {
    ...
    for (_iter558 = this->b3.begin(); _iter558 != this->b3.end(); ++_iter558)
    {
      {
  ...
  xfer += oprot->writeFieldBegin("b4", ::apache::thrift::protocol::T_MAP, 4);
  {
    ...
    for (_iter562 = this->b4.begin(); _iter562 != this->b4.end(); ++_iter562)
    {
      {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->struct_list.resize(_size567);
            uint32_t _i571;
            for (_i571 = 0; _i571 < _size567; ++_i571)
            {
              xfer += this->struct_list[_i571].read(iprot);
            }
            iprot->readListEnd();
          }
          this->__isset.struct_list = true;
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->enum_field = (SomeEnum)ecast572;
...
uint32_t TestUnion::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, this->struct_list.size());
    std::vector<RandomStuff> ::const_iterator _iter573;
    for (_iter573 = this->struct_list.begin(); _iter573 != this->struct_list.end(); ++_iter573)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype575, _vtype576, _size574);
            uint32_t _i578;
            for (_i578 = 0; _i578 < _size574; ++_i578)
            {
              int32_t _key579;
              xfer += iprot->readI32(_key579);
              int32_t& _val580 = this->somemap_field[_key579];
              xfer += iprot->readI32(_val580);
            }
            iprot->readMapEnd();
          }
...
uint32_t StructWithASomemap::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("somemap_field", ::apache::thrift::protocol::T_MAP, 1);
  {
    ...
    std::map<int32_t, int32_t> ::const_iterator _iter581;
    for (_iter581 = this->somemap_field.begin(); _iter581 != this->somemap_field.end(); ++_iter581)
    {
      xfer += oprot->writeI32(_iter581->first);
      xfer += oprot->writeI32(_iter581->second);
    }
    xfer += oprot->writeMapEnd();
  }
  xfer += oprot->writeFieldEnd();
