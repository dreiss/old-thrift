...
const char* TestUnion::ascii_fingerprint = "8BC951015AABA93BF62CD87CE949F54C";
const uint8_t TestUnion::binary_fingerprint[16] = {0x8B,0xC9,0x51,0x01,0x5A,0xAB,0xA9,0x3B,0xF6,0x2C,0xD8,0x7C,0xE9,0x49,0xF5,0x4C};
...
apache::thrift::reflection::local::FieldMeta
trlo_metas_DebugProtoTest_8BC951015AABA93BF62CD87CE949F54C[] = {
  { 1, false },
  { 2, false },
  { 3, false },
  { 4, false },
...
apache::thrift::reflection::local::TypeSpec*
trlo_specs_DebugProtoTest_8BC951015AABA93BF62CD87CE949F54C[] = {
  &trlo_typespec_DebugProtoTest_B45CFFE084DD3D20D928BEE85E7B0F21,
  &trlo_typespec_DebugProtoTest_F89EDB52B075B8BD95989BD3D0A04C0A,
  &trlo_typespec_DebugProtoTest_DF7CE78394886179BFAFDB65C5A708BC,
  &trlo_typespec_DebugProtoTest_3B817430713E83783602B9A6DEC628CA,
...
// {1:string;2:i32;3:{1:bool;2:bool;3:byte;4:i16;5:i32;6:i64;7:double;8:string;9:string;10:bool;11:string;12:list<byte>;13:list<i16>;14:list<i64>;};4:list<{1:i32;2:i32;3:i32;4:i32;5:list<i32>;6:map<i32,{1:{};}>;7:i64;8:double;}>;5:i32;}
apache::thrift::reflection::local::TypeSpec
trlo_typespec_DebugProtoTest_8BC951015AABA93BF62CD87CE949F54C(
  apache::thrift::protocol::T_STRUCT,
        ...
        if (ftype == apache::thrift::protocol::T_LIST) {
          {
            ...
            this->struct_list.resize(_size565);
            uint32_t _i569;
            for (_i569 = 0; _i569 < _size565; ++_i569)
            {
              xfer += this->struct_list[_i569].read(iprot);
            }
            iprot->readListEnd();
          }
          this->__isset.struct_list = true;
...
uint32_t TestUnion::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(apache::thrift::protocol::T_STRUCT, this->struct_list.size());
    std::vector<RandomStuff> ::const_iterator _iter570;
    for (_iter570 = this->struct_list.begin(); _iter570 != this->struct_list.end(); ++_iter570)
    {
...
const char* StructWithAUnion::ascii_fingerprint = "BA0B329A8FB8C252EBF6CD11D1C48F2D";
const uint8_t StructWithAUnion::binary_fingerprint[16] = {0xBA,0x0B,0x32,0x9A,0x8F,0xB8,0xC2,0x52,0xEB,0xF6,0xCD,0x11,0xD1,0xC4,0x8F,0x2D};

apache::thrift::reflection::local::FieldMeta
trlo_metas_DebugProtoTest_BA0B329A8FB8C252EBF6CD11D1C48F2D[] = {
  { 1, false },
  { 0, false }
};
apache::thrift::reflection::local::TypeSpec*
trlo_specs_DebugProtoTest_BA0B329A8FB8C252EBF6CD11D1C48F2D[] = {
  &trlo_typespec_DebugProtoTest_8BC951015AABA93BF62CD87CE949F54C,
  &trlo_typespec_DebugProtoTest_CAB8111FD0B710A336C898E539090E34,
};
// {1:{1:string;2:i32;3:{1:bool;2:bool;3:byte;4:i16;5:i32;6:i64;7:double;8:string;9:string;10:bool;11:string;12:list<byte>;13:list<i16>;14:list<i64>;};4:list<{1:i32;2:i32;3:i32;4:i32;5:list<i32>;6:map<i32,{1:{};}>;7:i64;8:double;}>;5:i32;};}
apache::thrift::reflection::local::TypeSpec
trlo_typespec_DebugProtoTest_BA0B329A8FB8C252EBF6CD11D1C48F2D(
  apache::thrift::protocol::T_STRUCT,
        ...
        if (ftype == apache::thrift::protocol::T_MAP) {
          {
            ...
            iprot->readMapBegin(_ktype572, _vtype573, _size571);
            uint32_t _i575;
            for (_i575 = 0; _i575 < _size571; ++_i575)
            {
              int32_t _key576;
              xfer += iprot->readI32(_key576);
              int32_t& _val577 = this->somemap_field[_key576];
              xfer += iprot->readI32(_val577);
            }
            iprot->readMapEnd();
          }
...
uint32_t StructWithASomemap::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("somemap_field", apache::thrift::protocol::T_MAP, 1);
  {
    ...
    for (_iter578 = this->somemap_field.begin(); _iter578 != this->somemap_field.end(); ++_iter578)
    {
